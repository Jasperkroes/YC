...
public class Winkel{
	...
	static LinkedList<Product> items = new LinkedList<Product>();
	...
	static void doorwinkelen(Scanner sc, int totaal){
		System.out.println("Wilt u (nog) wat kopen? (1 = ja, 2 = nee)");
		if(sc.nextInt() == 1) {
			showItems();			
	...
	static void showtotal(int totaal){
